...
public class GaussianDataset {
    ...
    ///   - maxResolution: Cap the loaded image long edge before training (0 = uncapped).
    ...
    public init(path: String, downscaleFactor: Float = 1.0,
        ...
        handle = msplat_dataset_create_ex(path, downscaleFactor, maxResolution,
                                          evalMode, testEvery, maxCameras)
    }
